...
%% Debug function for logging update hooks' values
\def\lc@update@hook@log{%
    \begingroup
        \h=0\loop
            \immediate\write16{Alive hook \#\the\h: \expandafter\meaning\csname lc@update@alive@hook@\the\h\endcsname.}
            \advance\h1
        \ifnum\h<9\repeat
        \h=0\loop
            \immediate\write16{Dead hook \#\the\h: \expandafter\meaning\csname lc@update@dead@hook@\the\h\endcsname.}
            \advance\h1
        \ifnum\h<9\repeat
    \endgroup
}
