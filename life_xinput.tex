...
\def\l@input@header+1^^M{\l@input@header@parse+1, @END, \l@rule@init\l@input@header@make\l@input@body@parse}%
...
\def\l@input@header@make{%
    \line{\hskip -2em\magtensc Conway's Game of Life. \hss \tt Rule B\l@rule@B/S\l@rule@S, Iteration \the\lb@iter}\vskip 2ex
